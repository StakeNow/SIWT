...
describe('utils/siwt.utils', () => {
  ...
  describe('packMessagePayload', () => {
    it('should create the message payload as expected', () => {
      ...
      const expected =
        ''
  ...
  describe('calculateLength', () => {
    it('should calculate the length as expected', () => {
      // when ... we want to calculate the length of a string
      // then ... it should calculate it as expected

      const string = 'STRING'
      const result = SUT.calculateLength(string)
      const expected = '00000003'
      expect(result).toEqual(expected)
    })
  })
})
