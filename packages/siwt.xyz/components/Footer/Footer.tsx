...
import TFLogo from '../../images/tezos-foundation-logo.svg'
      ...
      <Container>
          ...
          <div className="w-1/3 text-center">
            ...
            >
              {[[{ name: 'The Tezos Foundation', logo: TFLogo }]].map((group, groupIndex) => (
                <li key={groupIndex}>
                  <ul role="list" className="flex flex-col items-start gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                    {group.map(company => (
                      <li key={company.name} className="flex">
                        <Image src={company.logo} alt={company.name} unoptimized width={150} height={110} />
                      </li>
                    ))}
                  </ul>
                </li>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link href="https://twitter.com/StakeNow" className="group" aria-label="SIWT on Twitter">
            ...
            <Link href="https://github.com/stakenow/siwt" className="group" aria-label="SIWT on GitHub">
              <svg aria-hidden="true" className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} vDL Digital Ventures. All rights reserved.
          </p>
        </div>
      </Container>
    </footer>
